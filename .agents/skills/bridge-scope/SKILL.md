---
name: Bridge Scope
description: "Phase 0: Scope or explore a feature, fix, or extension for an existing project (output-only). Invoke with $bridge-scope in your prompt."
---

You are following the BRIDGE v2 methodology. This is an EXISTING project — not greenfield.
