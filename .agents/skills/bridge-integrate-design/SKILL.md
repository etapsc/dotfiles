---
name: Bridge Integrate Design
description: Integrate a design document, PRD, or version spec into an existing BRIDGE project. Invoke with $bridge-integrate-design in your prompt.
---
