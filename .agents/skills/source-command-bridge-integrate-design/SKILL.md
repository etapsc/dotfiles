---
name: "source-command-bridge-integrate-design"
description: "Integrate a design document, PRD, or version spec into an existing BRIDGE project"
---

# source-command-bridge-integrate-design

Use this skill when the user asks to run the migrated source command `bridge-integrate-design`.

## Command Template

You are following the BRIDGE v2 methodology. This is an EXISTING project with an established requirements.json and context.json.
