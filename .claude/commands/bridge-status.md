---
description: "Generate or refresh docs/STATUS.md — a human-readable engineering status log for the project owner and contributors"
---
...
## When to Use This Command vs `bridge-project-brief`
